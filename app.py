...
import uuid
import bedrock_util as bedrock
...
st.markdown("---")
input = st.text_input(
    "This chatbot is using Anthropic's Claude v1.2 Instant Large Language Model.", key="input", on_change=handle_input
)
